...
public class StepCounterActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		showmap.setOnClickListener(new OnClickListener() {
		   public void onClick(View v) {
                //Intent showmap =new Intent(StepCounterActivity.this,MapActivity.class);
                //startActivity(showmap);
		        if(!position.isEmpty()){
    		        Bundle bundle = new Bundle();
    		        bundle.putStringArrayList("key", position);
                    Intent passIntent=new Intent(StepCounterActivity.this,MapActivity.class);
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case DISTANCE_MSG:
				...
				if(t != 0){
                    avespeedtext.setText(dfonedc.format((mDistance *1000 / (float)t*2.23694))
                            + "   "
                            + getResources().getString(
                                    R.string.avespeedunit));
                    Log.i("Average Speed",(mDistance*1000 / (float)t)*2.23694+"");
                }
