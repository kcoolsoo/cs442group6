...
public class StepCounterActivity extends Activity {
    ...
    private static double RUNNING_SPEED = 5; //assume if the speed is more than 5 mph, the runner is running
            ...
            chronometer.setOnChronometerTickListener(new Chronometer.OnChronometerTickListener() {
                ...
                public void onChronometerTick(Chronometer chronometer) {
                    ...
                    t = SystemClock.elapsedRealtime()
                            - chronometer.getBase();
                    if ( t % 5 ==0 && t != 0){
                        avespeedtext.setText(dfonedc.format((distance/t))+"   "+getResources().getString(R.string.avespeedunit));
                    }
                    display_time();
                }
            });
    ...
    private void startStepService() {
        if (! mIsRunning) {
            ...
            mIsRunning = true;
            startService(new Intent(StepCounterActivity.this,
                    StepService.class));
            startService(new Intent(StepCounterActivity.this, 
                    GpsService.class));
    ...
    private void bindStepService() {
        ...
        bindService(new Intent(StepCounterActivity.this, 
    ...
    private void stopStepService() {
        ...
        if (mService != null) {
            ...
            stopService(new Intent(StepCounterActivity.this,
                  StepService.class));
            stopService(new Intent(StepCounterActivity.this,
                    GpsService.class));
        }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case SPEED_MSG:
                     ...
                     speedtext.setText(currentspeed+"   "+getResources().getString(R.string.speedunit));
                    break;
                case DISTANCE_MSG:
                     float previousdis = distance;
                     distance = msg.arg1/1000000f;
                     mCalories +=  (mBodyWeight * ((currentspeed > RUNNING_SPEED) ? IMPERIAL_RUNNING_FACTOR :IMPERIAL_WALKING_FACTOR))
                             // Distance:
                             * (distance-previousdis) // centimeters
                             / 100000.0; // centimeters/kilometer
                     distancetext.setText(distance+"   " + getResources().getString(R.string.distanceunit));
                     calorietext.setText(df.format(mCalories) +"   " + getResources().getString(R.string.calorieunit));
                    break;
                default:
